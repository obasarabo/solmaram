...
<p>SolMaram — український виробник натуральних ліофілізованих овочів, фруктів та ягід. Ми контролюємо кожен етап процесу — від вибору сировини до запечатування готового пакунку — щоб лише природа потрапляла на ваш стіл.</p>

<p>Ми також є сертифікованим імпортером ЄС преміальних ліофілізованих продуктів, що привозимо найкраще з Європи нашим покупцям.</p>
...
<ul>
  ...
  <li><strong>100% натуральне</strong> — Ліофілізація зберігає смак, колір і поживні речовини. Без добавок і консервантів.</li>
</ul>
...
<blockquote><p>«Від поля до ліофілізації — чиста природа, нічого більше.»</p></blockquote>';
