...
$recipes = [
    ...
    [
        'ua' => [
            'title'       => 'Смузі-боул з ліофілізованими ягодами',
            'excerpt'     => 'Яскравий і поживний сніданок за 5 хвилин — без варіння і зайвого цукру.',
            'content'     => '<p>Ліофілізовані ягоди розкривають весь свій смак у кремовій основі зі сметани або йогурту. Страва готується за кілька хвилин і виглядає як у ресторані.</p>',
            'ingredients' => [
                '150 г натурального йогурту або сметани',
                '2 ст. л. ліофілізованої полуниці',
                '1 ст. л. ліофілізованої чорниці',
                '1 банан (для основи)',
                '1 ч. л. меду',
            ...
            'steps' => [
                ...
                'Рівномірно розкладіть зверху ліофілізовані ягоди.',
    ...
    [
        'ua' => [
            'title'       => 'Швидкий овочевий суп із ліофілізованими овочами',
            'excerpt'     => 'Ситний суп із тривалим терміном зберігання інгредієнтів — ідеально для кемпінгу та зайнятих буднів.',
            'content'     => '<p>Ліофілізовані овочі відновлюються у гарячій воді за кілька хвилин і зберігають смак та поживність свіжих. Суп виходить насиченим і ароматним без тривалого приготування.</p>',
            'ingredients' => [
                '1 л курячого або овочевого бульйону',
                '2 ст. л. ліофілізованої моркви',
                '2 ст. л. ліофілізованого горошку',
                '1 ст. л. ліофілізованого шпинату',
                '50 г дрібної локшини або вермішелі',
                'Сіль, перець, зелень за смаком',
            ],
            'steps' => [
                'Доведіть бульйон до кипіння у каструлі.',
                'Додайте ліофілізовані овочі та перемішайте.',
